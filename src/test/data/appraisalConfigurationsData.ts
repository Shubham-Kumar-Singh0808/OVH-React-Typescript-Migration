import { GetAppraisalCycleResponse } from '../../types/Settings/Configurations/appraisalConfigurationsTypes'

export const mockAppraisalCycle: GetAppraisalCycleResponse = {
  size: 42,
  list: [
    {
      id: 1,
