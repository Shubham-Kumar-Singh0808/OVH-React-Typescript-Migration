...
export const dateFormatPerLocale = [
  ...
  { label: 'en-PH', format: 'M/d/yyyy' },
  { label: 'en-SG', format: 'd/M/yyyy' },
  { label: 'en-TT', format: format2 },
  { label: 'en-US', format: 'M/d/yyyy' },
  { label: 'en-ZA', format: format1 },
  { label: 'en-ZW', format: 'M/d/yyyy' },
