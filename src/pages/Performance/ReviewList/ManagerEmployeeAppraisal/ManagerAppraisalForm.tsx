...
import ReviewHistoryDetails from '../../MyReviews/ReviewHistory/ReviewHistoryDetails'
import ReviewFormTable from '../../MyReviews/ReviewForm/ReviewFormTable'

const ManagerAppraisalForm = (): JSX.Element => {
