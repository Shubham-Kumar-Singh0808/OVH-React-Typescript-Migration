...
const toRender = (
  <div>
    ...
    <div id="root"></div>
    <HRClearanceCertificateDetails />,
  </div>
)
const mockSetTogglePage = jest.fn()
describe('HRClearanceCertificateDetails Component Testing', () => {
  describe('should render HRClearanceCertificateDetails Component without data', () => {
    beforeEach(() => {
      render(toRender, {
        preloadedState: {
          resignationList: {
