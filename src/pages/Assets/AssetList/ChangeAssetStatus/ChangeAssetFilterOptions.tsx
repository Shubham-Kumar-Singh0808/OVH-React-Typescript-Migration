...
const ChangeAssetFilterOptions = ({
  ...
  const [vendorListFlag, setVendorListFlag] = useState<string>('')
      ...
      {vendorListFlag === '' && (
        <>
          ...
          <CRow className="mt-3 ">
            ...
            <CCol sm={2}>
              <Link
                to={`vendorList?vendorListFlag=ADDVENDOR`}
          ...
          <CRow className="mt-4 mb-4">
            ...
            <CCol sm={3}>
              ...
              <span className="text-danger" data-testid="errorMessage">
                <b>
                  <strong>Note:</strong> This field is mandatory for assembly
                  part (Ex- CPU, Chair){' '}
                </b>
              </span>
            </CCol>
          ...
          <CRow className="mt-3 mb-3">
            ...
            >
              Status Date:
              <span className={statusDate ? 'text-white' : 'text-danger'}>
                *
              </span>
            </CFormLabel>
            <CCol sm={3}>
          ...
          <CRow className="mt-4 mb-4">
            ...
            >
              Description:
              <span className={description ? 'text-white' : 'text-danger'}>
                *
              </span>
            </CFormLabel>
            {isShowEditor ? (
