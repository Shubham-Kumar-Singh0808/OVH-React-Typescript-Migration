...
describe('Achievement Timeline Rendering', () => {
  describe('render', () => {
    ...
    test('render the description modal', () => {
      const desc = screen.getByTestId('Description')
      expect(desc).toBeInTheDocument()
      const descContent = screen.getByTestId('desc-content')
      expect(descContent).toBeTruthy()
      expect(descContent).toHaveAttribute('role')
      fireEvent.click(descContent)
      expect(screen.getByTestId('model-content')).toBeTruthy()
    })
  })
})
