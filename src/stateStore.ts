...
import assetTypeListReducer from './reducers/Assets/ProductSpecificationList/AddNewProduct/AddProductSpecificationListSlice'
...
export const allReducers = {
  ...
  assetType: assetTypeListReducer,
